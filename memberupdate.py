...
def showmemberupdate():
    ...
    def updatedata():
        ...
        xc=e3.get()
        xd=e4.get()
        sql="Update members set memname='%s',memaddress='%s',memphoneno='%s' where memid=%d"%(xb,xc,xd,xa)
        cur.execute(sql)
        db.commit()
        db.close()
    ...
    b=Label(t,text='Members Name',font=("Arial",15),bg='light blue')
    b.place(x=75,y=200)
    e2=Entry(t,width='25')
    e2.place(x=250,y=200)
    
    c=Label(t,text='Members Address',font=("Arial",15),bg='light blue')
    c.place(x=75,y=250)
    e3=Entry(t,width='25')
    e3.place(x=250,y=250)
    
    
    f=Label(t,text='Members Phoneno',font=("Arial",15),bg='light blue')
    f.place(x=75,y=300)
    e4=Entry(t,width='25')
